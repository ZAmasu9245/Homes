...
SPROP.Settings.PurchaseMade 			= "Vous avez acheté la propriété !";
SPROP.Settings.SoldMade					= "Vous avez vendu la propriété pour $[x] !";
SPROP.Settings.CantPurchase				= "Vous ne pouvez pas vous permettre de payer cette propriété, vous n'avez pas assez sur vous !";
SPROP.Settings.Close					= "Fermer";
SPROP.Settings.ForSale					= "À vendre !";
SPROP.Settings.Currency					= "$";
SPROP.Settings.Purchase					= "Acheter";
SPROP.Settings.Extend					= "Étendre";
SPROP.Settings.Sell						= "Vendre";
SPROP.Settings.Confirm					= "Cliquez à nouveau";
SPROP.Settings.OwnedByYou				= "Vous";
SPROP.Settings.AddCoOwner				= "Ajouter un co-propriétaire";
SPROP.Settings.DelCoOwner				= "Retirer un co-propriétaire";
SPROP.Settings.UnownTime				= 120; // if not using timed properties, doors will be owned this many seconds after dc(incase crash)
SPROP.Settings.Owned					= "Cette propriété appartient à [x]"; // [x] is replaced with the owenrs name
SPROP.Settings.BoxWidth					= 300;
SPROP.Settings.NoAccess					= "Vous n'avez pas accès à ces propriétés";

SPROP.Settings.LineH					= 3;
SPROP.Settings.LineClr					= Color( 0, 210, 130, 140 );
...
SPROP.Settings.SearchDefaultText		= "Commencez à écrire pour rechercher";
...
SPROP.Settings.NoneAvailable = "Je n'ai aucune propriété gratuite en ce moment, revenez plus tard.";
